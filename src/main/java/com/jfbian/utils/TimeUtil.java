...
public class TimeUtil {
    ...
    public static int getDiffDays(Date beginDate, Date endDate) {
        ...
        final long diff = (endDate.getTime() - beginDate.getTime()) / (1000 * 60 * 60 * 24);
    ...
    public static Date getFirstSeasonDate(Date date) {
        ...
        final Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        final int sean = SEASON[cal.get(Calendar.MONTH)];
    ...
    public static List getTimeList(int beginYear, int beginMonth, int k) {
        ...
        final int max = begincal.getActualMaximum(Calendar.DATE);
    ...
    public static String CSTFormat(String str) throws ParseException {
        final SimpleDateFormat formatter = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy", Locale.US);
        final Date date = formatter.parse(str);
    ...
    public static String getTwoDay(String secondString, String firstString) {
        ...
        long day = 0;
        try {
            final java.util.Date secondTime = myFormatter.parse(secondString);
            final java.util.Date firstTime = myFormatter.parse(firstString);
    ...
    public static String getPreTime(String StringTime, String minute) {
        ...
        String mydate1 = "";
        try {
            final Date date1 = format.parse(StringTime);
            final long Time = date1.getTime() / 1000 + Integer.parseInt(minute) * 60;
    ...
    public static long getDays(String date1, String date2) {
        ...
        final long day = (date.getTime() - mydate.getTime()) / (24 * 60 * 60 * 1000);
        return day;
    }
    ...
    public static String getNowMonth(String sdate) {
        ...
        final String newday = getNextDay(sdate, 1 - u + "");
        return newday;
    }
